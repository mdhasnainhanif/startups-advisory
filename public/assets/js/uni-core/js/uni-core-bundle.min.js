/*! UniCore 3.19.1 | https://www.unistudio.co | (c) 2023 - 2024 UniStudio | MIT License */ !(function (t, e) {
    ...
    const ct = { area: !0, base: !0, br: !0, col: !0, embed: !0, hr: !0, img: !0, input: !0, keygen: !0, link: !0, meta: !0, param: !0, source: !0, track: !0, wbr: !0 };
    function dt(t) {
                            ...
                            (t) =>
                                new Promise((s, o) => {
                                    ...
                                    qt(
                                        ...
                                        [ie, ne],
                                        ({ type: e }) => {
                                            clearTimeout(r), st(t, ee), Qt(t, { transitionProperty: "", transitionDuration: "", transitionTimingFunction: "" }), e === ne ? o() : s(t);
                                        },
                                        { self: !0 }
                                    ),
                                        nt(t, ee),
                                        Qt(t, { transitionProperty: Object.keys(e).map(te).join(","), transitionDuration: `${i}ms`, transitionTimingFunction: n, ...e });
                                })
                        )
                    )
                );
            ...
            ? L(We(t), (t) => {
                  ...
                  return s
                      ? (function (t, e) {
                            ...
                            "vh" === s
                                ? Re || (Ue || ((Ue = Te("<div>")), Qt(Ue, { height: "100vh", position: "fixed" }), Lt(window, "resize", () => (Re = null))), me(document.body, Ue), (Re = Ue.clientHeight), be(Ue), Re)
                                : "vw" === s
                                ? Ne(O(i))
                                : n
                                ? i[`offset${l(e)}`]
    ...
    function _i(t) {
        ...
        if (b(i) && e.visualViewport) {
            ...
            return (t = Math.round(t * n)), (i = Math.round(i * n)), { height: t, width: i, top: s, left: o, bottom: s + t, right: o + i };
        }
        let n = Me(i);
    ...
    function Fi(t, e, i) {
        (i = { attach: { element: ["left", "top"], target: ["left", "top"], ...i.attach }, offset: [0, 0], placement: [], ...i }), f(e) || (e = [e, e]), Me(t, ji(t, e, i));
    }
    function ji(t, e, i) {
        const n = Li(t, e, i),
    ...
    function Yi(...t) {
        let e = {};
        for (const i of t) for (const [, , t, n] of Hi) (e[t] = Math.max(e[t] || 0, i[t])), (e[n] = Math.min(...[e[n], i[n]].filter(Boolean)));
        return e;
    }
    function Xi(t, e, i) {
        const [, , n, s] = Hi[i];
    ...
    function Gi(t, e, i) {
        return ji(t, e, { ...i, attach: { element: i.attach.element.map(Ki).reverse(), target: i.attach.target.map(Ki).reverse() }, offset: i.offset.reverse(), placement: i.placement.reverse(), recursion: !0 });
    }
    function Zi(t, e) {
        const i = [...t],
            n = Hi[e].indexOf(t[e]);
    ...
    function hn(t, e, i) {
        const s = {};
        if ((g(e) && (e = e.options), e.extends && (t = hn(t, e.extends, i)), e.mixins)) for (const n of e.mixins) t = hn(t, n, i);
    ...
    (on.events = on.watch = on.observe = on.created = on.beforeConnect = on.connected = on.beforeDisconnect = on.disconnected = on.destroy = an),
    ...
    var Sn = {
        ...
        observe: [gn({ options: { childList: !0, attributes: !0, attributeFilter: ["style"] } }), pn({ target: ({ $el: t }) => [t, ...St(t)] })],
        update: {
            read() {
                return { rows: In(p(this.$el.children)) };
            },
            write({ rows: t }) {
                for (const e of t) for (const i of e) lt(i, this.margin, t[0] !== e), lt(i, this.firstColumn, e[Xe ? e.length - 1 : 0] === i);
            },
            events: ["resize"],
        },
    };
            ...
            h = a(async () => {
                ...
                a !== h && d.push(se.start(e, { height: h }, i / 2 + c.length * n, "ease")),
                    await Promise.all(d).then(() => {
                        st(e, Tn), s === An(e) && (Qt(e, { height: "", alignContent: "" }), Qt(l, { opacity: "" }), delete e.dataset.transition);
                    });
            });
    ...
    async function Mn(t, e, i) {
        ...
        const r = Q(e, "style"),
            ...
            [l, h] = (function (t, e, i) {
                const n = e.map((t, e) => !(!vt(t) || !(e in i)) && (i[e] ? (ut(t) ? Bn(t) : { opacity: 0 }) : { opacity: ut(t) ? 1 : 0 })),
                    s = n.map((n, s) => {
    ...
    function _n(t, e) {
        const i = Qt(t, "zIndex");
        return !!ut(t) && { display: "", opacity: e ? Qt(t, "opacity") : "0", pointerEvents: "none", position: "absolute", zIndex: "auto" === i ? It(t) : i, ...Bn(t) };
    }
    function Bn(t) {
    ...
    var Un = {
        ...
        computed: { children: ({ target: t }, e) => Ee(`${t} > *`, e), toggles: ({ attrItem: t }, e) => Ee(`[${t}],[data-${t}]`, e) },
        watch: {
            toggles(t) {
                this.updateState();
        ...
        methods: {
            ...
            getState() {
                return this.toggles.filter((t) => at(t, this.cls)).reduce((t, e) => Xn(e, this.attrItem, t), { filter: { "": "" }, sort: [] });
            },
                            ...
                            (function (t, e, i) {
                                ...
                                if (s) {
                                    const t = (function (t, e, i) {
                                        return [...t].sort((t, n) => it(t, e).localeCompare(it(n, e), void 0, { numeric: !0 }) * ("asc" === i || -1));
                                    })(i, s, o);
                                    N(t, i) || me(e, t);
                                }
                            })(t, i, St(i)),
    ...
    function Xn(t, e, i) {
        ...
        return (n || A(o)) && (s ? (n ? (delete i.filter[""], (i.filter[s] = n)) : (delete i.filter[s], (E(i.filter) || "" in i.filter) && (i.filter = { "": n || "" }))) : (i.filter = { "": n || "" })), A(o) || (i.sort = [o, r]), i;
    }
    ...
    function Kn(t) {
        ...
        return (
            Qt(i, { overflowY: CSS.supports("overflow", "clip") ? "clip" : "hidden", touchAction: "none", paddingRight: Ne(window) - i.clientWidth || "" }),
            () => {
    ...
    var Qn = {
        ...
        ts = {
            ...
            data: { cls: !1, animation: [!1], duration: 200, velocity: 0.2, origin: !1, transition: "ease", clsEnter: "uc-togglable-enter", clsLeave: "uc-togglable-leave" },
            computed: { hasAnimation: ({ animation: t }) => !!t[0], hasTransition: ({ animation: t }) => ["slide", "reveal"].some((e) => h(t[0], e)) },
            methods: {
                ...
                _toggle(t, e) {
                    ...
                    let i;
                    (e = !!e),
                        this.cls ? ((i = d(this.cls, " ") || e !== at(t, this.cls)), i && lt(t, this.cls, d(this.cls, " ") ? void 0 : e)) : ((i = e === t.hidden), i && (t.hidden = !e)),
    ...
    async function is(t, e, { animation: i, duration: n, velocity: s, transition: o, _toggle: r }) {
        ...
        !w && !e && (v += y);
        const [I] = $e(t, "<div>");
        Qt(I, { boxSizing: "border-box", height: x.height, width: x.width, ...Qt(t, ["overflow", "padding", "borderTop", "borderRight", "borderBottom", "borderLeft", "borderImage", g]) }),
            Qt(t, { padding: 0, border: 0, minWidth: 0, minHeight: 0, [g]: 0, width: x.width, height: x.height, overflow: "hidden", [p]: v });
        const k = v / S;
        n = (s * S + n) * (e ? 1 - k : k);
        const C = { [p]: e ? S : 0 };
        f && (Qt(t, m, S - v + $), (C[m] = e ? $ : S + $)), !f ^ ("reveal" === l) && (Qt(I, m, -S + v), se.start(I, { [m]: e ? 0 : -S }, n, o));
        try {
        ...
        events: [
            ...
            },
            {
                ...
                handler() {
                    ...
                    qt(this.$el, "hidden", () => t.forEach((t) => t && t()), { self: !0 }), nt(document.documentElement, this.clsPage);
                },
            },
            {
                name: "shown",
    ...
    var cs = { slide: { show: (t) => [{ transform: us(-100 * t) }, { transform: us() }], percent: (t) => ds(t), translate: (t, e) => [{ transform: us(-100 * e * t) }, { transform: us(100 * e * (1 - t)) }] } };
    function ds(t) {
        ...
        methods: {
            ...
            move(t) {
                ...
                ((this.index === n && this.prevIndex !== n) || u) && Vt(i[this.index], "itemshown", [this]),
                    h && ((this.prevIndex = n), (this.index = o), c || (Vt(a, "beforeitemhide", [this]), Vt(a, "itemhide", [this])), Vt(l, "beforeitemshow", [this]), Vt(l, "itemshow", [this])),
                ...
                setTimeout(() => Wt(this.list, "click", $s, vs)), Qt(this.list, { userSelect: "" }), (this.drag = this.percent = null);
            },
        },
    };
    function Ss(t, e) {
    ...
    function Cs(t) {
        t._hasComputed &&
            ((function (t, e) {
                ...
                read: () =>
                    (function (t, e) {
                        for (const { name: i, handler: s, immediate: o = !0 } of t._watches) ((t._initial && o) || (n(e, i) && !N(e[i], t[i]))) && s.call(t, t[i], e[i]);
                        t._initial = !1;
                    })(t, Ts(t)),
    ...
    let Es, As;
    function Ds(t, e, i) {
        let { name: n, el: s, handler: o, capture: r, passive: a, delegate: l, filter: h, self: c } = w(e) ? e : { name: i, handler: e };
        (s = g(s) ? s.call(t, t) : s || t.$el), !(!s || (f(s) && !s.length) || (h && !h.call(t))) && t._events.push(Lt(s, n, l ? (k(l) ? l : l.call(t, t)) : null, k(o) ? t[o] : o.bind(t), { passive: a, capture: r, self: c }));
    }
    function Ps(t, ...e) {
        t._observers.push(...e);
    }
    ...
    var Qs = {
            ...
            watch: {
                ...
                slides(t) {
                    t.forEach((t, e) => Q(t, { role: this.nav ? "tabpanel" : "group", "aria-label": this.t("slideLabel", e + 1, this.length), "aria-roledescription": this.nav ? null : "slide" }));
                },
                length(t) {
            ...
            methods: {
                updateNav() {
                    ...
                    for (const e of this.navItems) {
                        ...
                        if (T(i)) {
                            const s = P(i) === t;
                            lt(e, this.clsActive, s), lt(n, "uc-disabled", this.parallax), Q(n, { "aria-selected": s, tabindex: s && !this.parallax ? null : -1 }), s && n && bt(vt(e), ":focus-within") && n.focus();
    ...
    var io = {
                ...
                Transitioner: function (t, e, i, { animation: n, easing: s }) {
                    ...
                    return {
                        ...
                        translate(n) {
                            this.reset();
                            const s = r(n, i);
                            Qt(e, s[1]), Qt(t, s[0]), ps(e, "itemtranslatein", { percent: n, dir: i }), ps(t, "itemtranslateout", { percent: 1 - n, dir: i });
                        },
                        percent: () => o(t || e, e, i),
        ...
        no = {
            ...cs,
            fade: { show: () => [{ opacity: 0 }, { opacity: 1 }], percent: (t) => 1 - Qt(t, "opacity"), translate: (t) => [{ opacity: 1 - t }, { opacity: t }] },
            scale: {
                show: () => [
            ...
            events: [
                ...
                },
                {
                    ...
                    async handler(t, e) {
                        ...
                        let a;
                        const l = { allowfullscreen: "", style: "max-width: 100%; box-sizing: border-box;", "uc-responsive": "", "uc-video": `${this.videoAutoplay}` };
                        if ("image" === n || i.match(/\.(avif|jpe?g|jfif|a?png|gif|svg|webp)($|\?)/i)) {
                            ...
                            const t = oo("video", { src: i, poster: o, controls: "", playsinline: "", "uc-video": `${this.videoAutoplay}`, ...r });
                            Lt(t, "loadedmetadata", () => this.setItem(e, t)), Lt(t, "error", () => this.setError(e));
                        } else if ("iframe" === n || i.match(/\.(html|php)($|\?)/i)) this.setItem(e, oo("iframe", { src: i, allowfullscreen: "", class: "uc-lightbox-iframe", ...r }));
                        else if ((a = i.match(/\/\/(?:.*?youtube(-nocookie)?\..*?(?:[?&]v=|\/shorts\/)|youtu\.be\/)([\w-]{11})[&?]?(.*)?/)))
                            this.setItem(e, oo("iframe", { src: `https://www.youtube${a[1] || ""}.com/embed/${a[2]}${a[3] ? `?${a[3]}` : ""}`, width: 1920, height: 1080, ...l, ...r }));
                            ...
                            try {
                                ...
                                this.setItem(e, oo("iframe", { src: `https://player.vimeo.com/video/${a[1]}${a[2] ? `?${a[2]}` : ""}`, width: n, height: t, ...l, ...r }));
                            } catch {
                                this.setError(e);
                            }
                    },
    ...
    var lo = {
        ...
        functional: !0,
        args: ["message", "status"],
        data: { message: "", status: "", timeout: 5e3, group: "", pos: "top-center", clsContainer: "uc-notification", clsClose: "uc-notification-close", clsMsg: "uc-notification-message" },
        install: function (t) {
        ...
        async connected() {
            ...
            await se.start(Qt(this.$el, this.startProps), { opacity: 1, [this.marginProp]: t }), this.timeout && (this.timer = setTimeout(this.close, this.timeout));
        },
        events: {
            click(t) {
                t.target.closest('a[ ],a[href=""]') && t.preventDefault(), this.close();
            },
            [ti]() {
    ...
    var Mo = {
        ...
        observe: [wn(), bn({ target: ({ target: t }) => t }), pn({ target: ({ $el: t, target: e }) => [t, e, Pi(e, !0)] })],
        update: {
            read({ percent: t }, e) {
                if ((e.has("scroll") || (t = !1), !ut(this.$el))) return !1;
                if (!this.matchMedia) return;
                const i = t;
                return { percent: (t = Po(Ai(this.target, this.start, this.end), this.easing)), style: i !== t && this.getCss(t) };
            },
            write({ style: t }) {
    ...
    var Bo = {
        props: { parallax: Boolean, parallaxTarget: Boolean, parallaxStart: String, parallaxEnd: String, parallaxEasing: Number },
        data: { parallax: !1, parallaxTarget: !1, parallaxStart: 0, parallaxEnd: 0, parallaxEasing: 0 },
        observe: [pn({ target: ({ $el: t, parallaxTarget: e }) => [t, e], filter: ({ parallax: t }) => t }), bn({ filter: ({ parallax: t }) => t })],
        computed: {
        ...
        update: {
            write() {
                ...
                const t = this.parallaxTarget,
                    ...
                    o = this.slides[i],
                    r = this.slides[s],
                    { triggerShow: a, triggerShown: l, triggerHide: h, triggerHidden: c } = (function (t) {
                ...
                if (~this.prevIndex) for (const t of new Set([this.index, this.prevIndex])) d([s, i], t) || (h(this.slides[t]), c(this.slides[t]));
                    ...
                    translate(n) {
                        ...
                        for (const s of St(o)) {
                            const a = d(r, s),
                                c = s === l,
                                u = s === h;
                            Wo(s, "itemtranslate" + (c || (!u && (a || (i * (Xe ? -1 : 1) == -1) ^ (jo(s, o) > jo(t || e)))) ? "in" : "out"), { dir: i, percent: u ? 1 - n : c ? n : a ? 1 : 0 });
                        }
                    },
    ...
    var Yo = {
            ...cs,
            fade: { show: () => [{ opacity: 0, zIndex: 0 }, { zIndex: -1 }], percent: (t) => 1 - Qt(t, "opacity"), translate: (t) => [{ opacity: 1 - t, zIndex: 0 }, { zIndex: -1 }] },
            scale: { show: () => [{ opacity: 0, transform: fs(1.5), zIndex: 0 }, { zIndex: -1 }], percent: (t) => 1 - Qt(t, "opacity"), translate: (t) => [{ opacity: 1 - t, transform: fs(1 + 0.5 * t), zIndex: 0 }, { zIndex: -1 }] },
            pull: {
                show: (t) =>
                    t < 0
                        ? [
        ...
        Xo = {
            ...
            data: { ratio: "16:9", minHeight: void 0, maxHeight: void 0, selList: ".uc-slideshow-items", attrItem: "uc-slideshow-item", selNav: ".uc-slideshow-nav", Animations: Yo },
            watch: {
                list(t) {
                    Qt(t, { aspectRatio: this.ratio ? this.ratio.replace(":", "/") : void 0, minHeight: this.minHeight, maxHeight: this.maxHeight, minWidth: "100%", maxWidth: "100%" });
                },
            },
            methods: {
                getAdjacentSlides() {
            ...
            methods: {
                ...
                start(t) {
                    this.drag = (function (t, e) {
                        ...
                        return me(t, i), Qt(i, "margin", "0", "important"), Qt(i, { boxSizing: "border-box", width: e.offsetWidth, height: e.offsetHeight, padding: Qt(e, "padding") }), Oe(i.firstElementChild, Oe(e.firstElementChild)), i;
                ...
                move(t) {
                    ...
                    this === t ? this.origin.index !== It(this.placeholder) && Vt(this.$el, "moved", [this, this.placeholder]) : (Vt(t.$el, "added", [t, this.placeholder]), Vt(this.$el, "removed", [this, this.placeholder])),
                        Vt(this.$el, "stop", [this, this.placeholder]),
                        be(this.drag),
                        (this.drag = null);
                    for (const { clsPlaceholder: t, clsItem: e } of this.touched) for (const i of this.touched) st(i.items, t, e);
        ...
        methods: {
            positionAt(t, e, i) {
                ...
                const r = (function (t) {
                    ...
                    a = Pe(t);
                Qt(t, { top: -a.height, left: -a.width }), Fi(t, e, { attach: o, offset: n, boundary: i, placement: s, viewportOffset: this.getViewportOffset(t) }), r();
            },
        ...
        methods: {
            show() {
                ...
                const { delay: t = 0, title: e } = (function (t) {
                    ...
                    return ["delay", "title"].reduce((t, i) => ({ [i]: it(e, i), ...t }), { ...cn(it(e, i), ["title"]), ...n });
                })(this.$options);
                if (!e) return;
                ...
                const s = Ks(this);
                Q(this.$el, { title: null, "aria-describedby": s }), clearTimeout(this.showTimer), (this.showTimer = setTimeout(() => this._show(e, s), t));
            },
            async hide() {
                var t;
                bt(this.$el, "input:focus") ||
                    (clearTimeout(this.showTimer), this.isToggled(this.tooltip || null) && (await this.toggleElement(this.tooltip, !1, !1)), null == (t = this.reset) || t.call(this), be(this.tooltip), (this.tooltip = null));
            },
            async _show(t, e) {
                (this.tooltip = me(this.container, `<div id="${e}" class="uc-${this.$options.name}" role="tooltip"> <div class="uc-${this.$options.name}-inner">${t}</div> </div>`)),
                    Lt(this.tooltip, "toggled", (t, e) => {
                        ...
                        const o = [
                            qt(document, `keydown ${Ze}`, this.hide, !1, (t) => (t.type === Ze && !this.$el.contains(t.target)) || ("keydown" === t.type && t.keyCode === Hn)),
                    ...
                    i = async (t) => {
                        ...
                        try {
                            const t = await (function (t, e) {
                                const i = { data: null, method: "GET", headers: {}, xhr: new XMLHttpRequest(), beforeSend: R, responseType: "", ...e };
                                    ...
                                    .then(() =>
                                        (function (t, e) {
                                            return new Promise((i, n) => {
                                                ...
                                                Lt(s, "load", () => {
                                                    0 === s.status || (s.status >= 200 && s.status < 300) || 304 === s.status ? i(s) : n(m(Error(s.statusText), { xhr: s, status: s.status }));
                                                }),
    ...
    var nr,
        ...
        or = {
            mixins: [en, ho, sr],
            props: { ...Object.fromEntries(["duration", "x", "y", "translateX", "translateY", "color", "background"].map((t) => [t, null])), y: "list" },
            setup(t) {
                const e = t.x,
                    i = t.y;
                console.log(e, i);
    ...
    var fr = {
        ...
        data: { targets: "> *", active: !1, animation: !0, collapsible: !0, multiple: !1, clsOpen: "uc-open", toggle: "> .uc-accordion-title", content: "> .uc-accordion-content", offset: 0 },
        computed: {
        ...
        update() {
            ...
            for (const e in this.items) {
                ...
                Q(i, { role: de(i, "a") ? "button" : null, "aria-controls": n.id, "aria-expanded": s, "aria-disabled": !this.collapsible && t.length < 2 && s }),
        ...
        methods: {
            toggle(t, e) {
                ...
                if ((!this.multiple && !d(n, i[0]) && (i = i.concat(n)), !(!this.collapsible && n.length < 2 && d(n, t))))
                    return Promise.all(
                        i.map((t) =>
                                ...
                                if ((lt(t, this.clsOpen, i), !1 !== e && this.animation))
                                    return (async function (t, e, { content: i, duration: n, velocity: s, transition: o }) {
                                        ...
                                        const h = L(["marginTop", "marginBottom"], (t) => Qt(i, t)) + Pe(i).height,
                                            c = l / h;
                                        (n = (s * h + n) * (e ? 1 - c : c)), Qt(a, "height", l), await se.start(a, { height: e ? h : 0 }, n, o), ye(i), delete t._wrapper, e || pr(i, !0);
                                    })(t, i, this);
    ...
    function gr(t, e, { duration: i, transition: n, velocity: s }) {
        ...
        return Qt(t, "height", o), se.start(t, { height: 0, marginTop: 0, marginBottom: 0, paddingTop: 0, paddingBottom: 0, borderTop: 0, borderBottom: 0, opacity: 0 }, s * o + i, n);
    }
    var vr = {
            args: "autoplay",
    ...
    var yr = {
        ...
        computed: {
            boundary: ({ boundary: t, boundaryX: e, boundaryY: i }, n) => [Tt(e || t, n) || window, Tt(i || t, n) || window],
        ...
        events: [
            ...
            },
            {
                ...
                handler() {
                    ...
                    qt(this.$el, "hide", () => t.forEach((t) => t && t()), { self: !0 }), this.bgScroll || qt(this.$el, "hidden", Kn(this.$el), { self: !0 });
                },
            },
        ...
        methods: {
            ...
            position() {
                ...
                for (const [n, [s, o]] of i) this.axis !== s && d([s, !0], this.stretch) && Qt(this.$el, { [o]: Math.min(Me(this.boundary[n])[o], t[n][o] - 2 * e), [`overflow-${s}`]: "auto" });
                ...
                for (const [n, [s, o, r, a]] of i)
                    if (this.axis === s && d([s, !0], this.stretch)) {
                        const i = Math.abs(this.getPositionOffset()),
                            l = Me(this.target[n]),
                            h = Me(this.$el);
                        Qt(this.$el, { [o]: (l[r] > h[r] ? l[this.inset ? a : r] - Math.max(Me(this.boundary[n])[r], t[n][r] + e) : Math.min(Me(this.boundary[n])[a], t[n][a] - e) - l[this.inset ? r : a]) - i, [`overflow-${s}`]: "auto" }),
    ...
    var Er = {
        ...
        data: { align: Xe ? "right" : "left", clsDrop: "uc-dropdown", clsDropbar: "uc-dropnav-dropbar", boundary: !0, dropbar: !1, dropbarAnchor: !1, duration: 200, container: !1, selNavItem: "> li > a, > ul > li > a" },
        computed: {
                ...
                handler({ target: t }) {
                    ...
                    const e = this.getDropdown(t),
                        i = () => {
                            ...
                            Me(this.dropbar, { left: Me(this.dropbar).left, top: this.getDropbarOffset(e.getPositionOffset()) }), this.transitionTo(i - Me(this.dropbar).top + M(Qt(t, "marginBottom")), t);
                        };
        ...
        methods: {
            ...
            async transitionTo(t, e) {
                ...
                Qt(e, "clipPath", `polygon(0 0,100% 0,100% ${n}px,0 ${n}px)`),
                    Oe(i, n),
                    await Promise.all([se.start(i, { height: t }, this.duration), se.start(e, { clipPath: `polygon(0 0,100% 0,100% ${t}px,0 ${t}px)` }, this.duration).finally(() => Qt(e, { clipPath: "", transitionDelay: "" }))]).catch(R);
            },
            getDropdown(t) {
    ...
    function Ar(t, e, i) {
        ...
        let l = -1;
        a === Ln ? (l = 0) : a === jn ? (l = "last") : a === Wn ? (l = "previous") : a === Vn ? (l = "next") : a === zn && (null == (n = i.targetEl) || n.focus(), null == (s = i.hide) || s.call(i, !1)),
            ~l && (t.preventDefault(), null == (o = i.hide) || o.call(i, !1), e[Z(l, e, e.indexOf(i.targetEl || r))].focus());
    }
    var Dr = {
            mixins: [en],
            args: "target",
        ...
        Pr = {
            ...
            data: { margin: "uc-grid-margin", clsStack: "uc-grid-stack", masonry: !1, parallax: 0, parallaxStart: 0, parallaxEnd: 0, parallaxJustify: !1 },
            connected() {
    ...
    const qr = {
        ...
        Yr = {
            ...
            beforeConnect() {
                ...
                if (
                    ((this.icon = t ? "search-toggle-icon" : at(this.$el, "uc-search-icon") && xt(this.$el, ".uc-search-large") ? "search-large" : xt(this.$el, ".uc-search-navbar") ? "search-navbar" : this.$props.icon),
    ...
    var ca = {
        ...
        observe: [
            gn({ target: ({ target: t }) => t, options: { attributes: !0, attributeFilter: ["class"], attributeOldValue: !0 } }),
            {
                target: ({ target: t }) => t,
                observe: (t, e) => {
                    const i = ui([...t, document.documentElement], e),
                        n = [
                            ...
                            Lt(document, "shown hidden transitionend transitioncancel", (t) => (e(), i.unobserve(t.target))),
                        ];
                    return {
                        disconnect() {
        ...
        fa = {
            install: function ({ modal: t }) {
                ...
                (t.dialog = function (e, i) {
                    const n = t(`<div class="uc-modal"> <div class="uc-modal-dialog">${e}</div> </div>`, { stack: !0, role: "alertdialog", ...i });
                    return (
                        n.show(),
                        Lt(
                            n.$el,
                    ...
                    (t.alert = function (t, i) {
                        return e(
                            ({ i18n: e }) => `<div class="uc-modal-body">${k(t) ? t : fe(t)}</div> <div class="uc-modal-footer uc-text-right"> <button class="uc-button uc-button-primary uc-modal-close" autofocus>${e.ok}</button> </div>`,
                            i
                        );
                    }),
                    (t.confirm = function (t, i) {
                        return e(
                            ({ i18n: e }) =>
                                `<form> <div class="uc-modal-body">${k(t) ? t : fe(t)}</div> <div class="uc-modal-footer uc-text-right"> <button class="uc-button uc-button-default uc-modal-close" type="button">${
                                    e.cancel
                                }</button> <button class="uc-button uc-button-primary" autofocus>${e.ok}</button> </div> </form>`,
                            i,
                            () => Promise.reject()
                        );
                    }),
                    (t.prompt = function (t, i, n) {
                        const s = e(
                                ({ i18n: e }) =>
                                    `<form class="uc-form-stacked"> <div class="uc-modal-body"> <label>${k(t) ? t : fe(t)}</label> <input class="uc-input" value="${
                                        i || ""
                                        ...
                                        e.cancel
                                    }</button> <button class="uc-button uc-button-primary">${e.ok}</button> </div> </form>`,
                                n,
                                () => null,
                                () => r.value
                            ),
            ...
            mixins: [os],
            data: { clsPage: "uc-modal-page", selPanel: ".uc-modal-dialog", selClose: ".uc-modal-close, .uc-modal-close-default, .uc-modal-close-outside, .uc-modal-close-full" },
            events: [
                {
    ...
    var ga = {
        ...
        data: { clsDrop: "uc-navbar-dropdown", selNavItem: ".uc-navbar-nav > li > a,a.uc-navbar-item,button.uc-navbar-item,.uc-navbar-item a,.uc-navbar-item button,.uc-navbar-toggle", dropbarTransparentMode: !1 },
    ...
    var ba = {
            ...
            computed: { container: ({ selContainer: t }, e) => e.closest(t), content: ({ selContent: t }, e) => e.closest(t) },
            observe: pn({ target: ({ container: t, content: e }) => [t, e] }),
            update: {
                read() {
                    return !!(this.content && this.container && ut(this.$el)) && { max: Math.max(this.minHeight, Oe(this.container) - (Pe(this.content).height - Oe(this.$el))) };
                },
                write({ max: t }) {
        ...
        $a = {
            ...
            methods: {
                async scrollTo(t) {
                    (t = (t && Te(t)) || document.body), Vt(this.$el, "beforescroll", [this, t]) && (await Ei(t, { offset: this.offset }), Vt(this.$el, "scrolled", [this, t]));
                },
            },
        };
    const ya = new Set();
    function Sa(t) {
        if (!t.defaultPrevented) for (const e of ya) e.$el.contains(t.target) && kt(e.$el) && (t.preventDefault(), window.location.href !== e.$el.href && window.history.pushState({}, "", e.$el.href), e.scrollTo(Ct(e.$el)));
    }
    var Ia = {
            args: "cls",
            props: { cls: String, target: String, hidden: Boolean, margin: String, repeat: Boolean, delay: Number },
            data: () => ({ cls: "", target: !1, hidden: !0, margin: "-1px", repeat: !1, delay: 0, inViewClass: "uc-scrollspy-inview" }),
        ...
        Ca = {
            ...
            connected() {
                (this.start = Ea(this.start || this.top)),
                    ...
                    (this.placeholder = Te("+ .uc-sticky-placeholder", this.$el) || Te('<div class="uc-sticky-placeholder"></div>')),
                    (this.isFixed = !1),
                    this.setActive(!1);
            },
            beforeDisconnect() {
            ...
            update: [
                {
                    read({ height: t, width: e, margin: i, sticky: n }) {
                        ...
                        s && (Da(this.target), this.hide()), this.active || (({ height: t, width: e } = Me(this.$el)), (i = Qt(this.$el, "margin"))), s && this.show();
                        ...
                        return (
                            (n = a && !this.showOnUp && p + c === u && m === Math.min(a, Ta(!0, this.$el, 0, !0) - f - c + d) && "visible" === Qt(vt(this.$el), "overflowY")),
                            { start: p, end: m, offset: c, overflow: d, height: t, elHeight: f, width: e, margin: i, top: Be(h)[0], sticky: n, viewport: o }
                        );
                    },
                    write({ height: t, width: e, margin: i, offset: n, sticky: s }) {
                        ...
                        Qt(o, { height: t, width: e, margin: i }), (vt(o) !== vt(this.$el) || s ^ (It(o) < It(this.$el))) && ((s ? ge : ve)(this.$el, o), (o.hidden = !0));
                    },
                    events: ["resize"],
                },
                {
                    read({ scroll: t = 0, dir: e = "down", overflow: i, overflowScroll: n = 0, start: s, end: o, elHeight: r, height: a, sticky: l }) {
                        const h = document.scrollingElement.scrollTop,
                            c = t <= h ? "down" : "up",
                            d = this.isFixed ? this.placeholder : this.$el;
                        return { dir: c, prevDir: e, scroll: h, prevScroll: t, below: h > Me(d).top + (l ? Math.min(a, r) : a), offsetParentTop: Me(d.offsetParent).top, overflowScroll: V(n + V(h, s, o) - V(t, s, o), 0, i) };
                    },
                    write(t, e) {
                        const i = e.has("scroll"),
                            { initTimestamp: n = 0, dir: s, prevDir: o, scroll: r, prevScroll: a = 0, top: l, start: h, below: c } = t;
            ...
            methods: {
                ...
                hide() {
                    ...
                    this.setActive(!1), st(this.$el, this.clsFixed, this.clsBelow), e ? Qt(this.$el, "top", t) : Qt(this.$el, { position: "", top: "", width: "", marginTop: "" }), (this.placeholder.hidden = !0), (this.isFixed = !1);
                },
                update() {
                    let { width: t, scroll: e = 0, overflow: i, overflowScroll: n = 0, start: s, end: o, offset: r, offsetParentTop: a, sticky: l, below: h } = this._data;
                    const c = 0 !== s || e > s;
                    if (!l) {
                        let s = "fixed";
                        e > o && ((r += o - a + n - i), (s = "absolute")), Qt(this.$el, { position: s, width: t, marginTop: 0 }, "important");
                    }
    ...
    var Pa = {
        ...
        methods: {
            async getSvg() {
                return (
                    de(this.$el, "img") && !this.$el.complete && "lazy" === this.$el.loading && (await new Promise((t) => qt(this.$el, "load", t))),
                    (function (t, e) {
    ...
    var za = {
            ...
            data: { connect: "~.uc-switcher", toggle: "> * > :first-child", itemNav: !1, active: 0, cls: "uc-active", attrItem: "uc-switcher-item", selVertical: ".uc-nav", followFocus: !1, swiping: !0 },
            computed: {
            ...
            observe: [vn({ targets: ({ connectChildren: t }) => t }), xn({ target: ({ connects: t }) => t, filter: ({ swiping: t }) => t })],
            events: [
                {
                    name: "click keydown",
                    delegate() {
            ...
            update() {
                ...
                for (const e in this.toggles) {
                    ...
                    Q(i, "role", "tab"), n && ((i.id = Ks(this, i)), (n.id = Ks(this, n)), Q(i, "aria-controls", n.id), Q(n, { role: "tabpanel", "aria-labelledby": i.id }));
                }
            ...
            methods: {
                ...
                show(t) {
                    ...
                    this.children.forEach((t, e) => {
                        lt(t, this.cls, s === e), Q(this.toggles[e], { "aria-selected": s === e, tabindex: s === e ? null : -1 });
                    });
                    const o = i >= 0 && i !== n;
        ...
        events: [
            ...
            },
            {
                ...
                handler(t) {
                    ...
                    e || !(!I(this._showState) || ("blur" !== t.type && bt(this.$el, ":focus")) || ("blur" === t.type && bt(this.$el, ":hover")))
                        ? (e && I(this._showState) && i !== this._showState) || ((this._showState = e ? i : null), this.toggle("toggle" + (e ? "show" : "hide")))
            ...
            },
            {
                ...
                handler(t) {
                    let e;
                    (this._preventClick || t.target.closest('a[ ], a[href=""]') || ((e = t.target.closest("a[href]")) && (!this.isToggled(this.target) || (e.hash && bt(this.target, e.hash))))) && t.preventDefault(),
